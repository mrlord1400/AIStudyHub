            ...
            <%
                if (publicDocuments != null && !publicDocuments.isEmpty()) {
                    for (int i = 0; i < publicDocuments.size(); i++) {
                        ...
                        if (upperTitle.contains("MAS291")) {
                            subjectCode = "MAS291";
                        } else if (upperTitle.contains("PRJ301")) {
                            subjectCode = "PRJ301";
                        } else if (upperTitle.contains("DBI202")) {
                            subjectCode = "DBI202";
                        } else if (upperTitle.contains("IOT102")) {
                            subjectCode = "IoT102";
                        } else if (upperTitle.contains("SWP391")) {
                            subjectCode = "SWP391";
                        } else if (upperTitle.contains("SSG104")) {
                            subjectCode = "SSG104";
                        }
