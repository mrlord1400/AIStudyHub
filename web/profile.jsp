...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        html.dark .form-input:focus { background-color: #1f2937; }
        html.dark .tab-btn-inactive { color: #9ca3af; }
        html.dark .tab-btn-inactive:hover { color: #f3f4f6; background-color: #374151; }
        ...
        @layer components {
            ...
            .user-profile-link { @apply flex items-center space-x-3 px-2 py-2 rounded-xl bg-gray-50 dark:bg-gray-700 transition-colors cursor-pointer; }
            ...
            .form-card { @apply bg-white border border-gray-100 rounded-2xl p-7 shadow-sm max-w-3xl mb-6 transition-colors duration-200; }
            .form-label { @apply block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2; }
            .form-input { @apply w-full px-4 py-3 rounded-xl border border-gray-200 outline-none transition-all bg-gray-50 focus:bg-white text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500; }
            ...
            .btn-danger { @apply flex items-center justify-center space-x-2 px-6 py-2.5 bg-red-500 text-white rounded-xl font-semibold hover:bg-red-600 transition-colors text-sm shadow-sm shadow-red-100 cursor-pointer; }
            
            .tab-btn-active { @apply px-5 py-2.5 bg-indigo-600 text-white font-semibold text-sm rounded-xl shadow-sm transition-all; }
            .tab-btn-inactive { @apply px-5 py-2.5 text-gray-600 hover:bg-gray-100 font-medium text-sm rounded-xl transition-all; }
        }
    </style>
</head>
<body class="page-body">
        ...
        <form action="<%= request.getContextPath() %>/MainController" method="POST">
            ...
            <div id="tab-security-content" class="form-card hidden">
                ...
                <div class="space-y-5">
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                        <label class="form-label">Mật khẩu hiện tại <span class="text-red-500">*</span></label>
                        <input type="password" name="currentPassword" class="form-input bg-white dark:bg-gray-700" placeholder="Bắt buộc nhập mật khẩu hiện tại để xác nhận đổi" />
                    </div>
                </div>
    ...
    <script>
        function switchTab(tab) {
            ...
            // Đồng bộ trạng thái thẻ Input Required
