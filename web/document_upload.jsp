...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        html.dark .btn-danger { background-color: #1f2937; border-color: #ef4444; color: #f87171; }
        html.dark .btn-danger:hover { background-color: rgba(239, 68, 68, 0.1); }
        html.dark .conflict-option { background-color: #1f2937; border-color: #374151; }
        html.dark .conflict-option:hover { background-color: #374151; }
        ...
        @layer components {
            ...
            .btn-danger { @apply flex items-center justify-center space-x-2 px-6 py-2.5 bg-white border border-red-200 text-red-600 rounded-xl font-semibold hover:bg-red-50 transition-colors text-sm; }
        }
    </style>
</head>
<body class="page-body">
    ...
    <script>
        ...
        function handleFormSubmitAppend() {
            ...
            if (!titleInput || !CURRENT_FILE_EXT) return true;
