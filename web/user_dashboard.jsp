    ...
    <body class="page-body">
        ...
        <main class="main-content">
            <div class="header-container">
                ...
                <form action="<%= request.getContextPath()%>/SearchController" method="GET" class="flex-1 min-w-[200px] max-w-md mx-2">
                    <div class="relative">
                        <svg class="w-4 h-4 text-gray-400 absolute left-3.5 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><path stroke-linecap="round" d="m21 21-4.3-4.3"/></svg>
                        <input type="text" name="keyword" placeholder="Tìm kiếm tài liệu, thư mục..."
                               class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all bg-gray-50 focus:bg-white text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                    </div>
                </form>
