...
<html lang="vi" class="dark">
    <head>
        ...
        <style type="text/tailwindcss">
            ...
            html.dark #deposit-modal > div, html.dark #qr-modal > div, html.dark #admin-pending-modal > div {
                background-color: #1f2937 !important;
                color: #ffffff !important;
            }
            html.dark #deposit-modal h3, html.dark #qr-modal h3, html.dark #admin-pending-modal h3 {
                color: #ffffff !important;
            }
            html.dark #deposit-modal label {
                color: #e5e7eb !important;
            }
            html.dark #deposit-modal input {
                background-color: #374151;
                border-color: #4b5563;
                color: #ffffff;
            }
            ...
            html.dark #qr-modal .bg-gray-50, html.dark #admin-pending-modal .bg-amber-50 {
                background-color: #2d3748 !important;
            }
            html.dark #qr-modal .bg-white {
                background-color: #1f2937 !important;
                border-color: #374151 !important;
            }
            html.dark #qr-modal span, html.dark #qr-modal p {
                color: #d1d5db !important;
            }
            html.dark #qr-modal #qr-amount-display, html.dark #qr-modal #qr-memo-text {
        ...
        <aside class="sidebar">
            <div class="space-y-6 w-full">
                ...
                <nav class="space-y-1 w-full">
                    ...
                    <a href="<%= request.getContextPath()%>/FileExplorer.jsp" class="nav-link">
