...
<body class="page-body">
    ...
    <aside class="sidebar">
        <div class="space-y-6 w-full">
            <a href="<%= request.getContextPath()%>/admin_dashboard.jsp" class="flex items-center space-x-3 px-2 py-1 transition-opacity hover:opacity-80 block w-full">
            ...
            <nav class="space-y-1 w-full">
                ...
                <a href="<%= request.getContextPath()%>/admin_manageTrans.jsp" class="nav-link">
