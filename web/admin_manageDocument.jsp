                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors <%= flagged ? "bg-red-50/40 dark:bg-red-950/20" : ""%>">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="<%= request.getContextPath()%>/MainController?action=adminReportList&documentId=<%= d.getDocumentId()%>" 
                                           class="inline-flex items-center space-x-1.5 px-4 py-2 bg-amber-100 text-amber-700 rounded-xl font-semibold hover:bg-amber-200 transition-colors text-sm shadow-sm dark:bg-amber-900/30 dark:text-amber-400 dark:hover:bg-amber-900/50">
