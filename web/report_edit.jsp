...
<%
    ...
    // 3. Đọc dữ liệu Report cũ từ Request Attributes (Do ReportController chuyển sang)
    Report existingReport = (Report) request.getAttribute("report");
    String errorMessage = (String) request.getAttribute("errorMessage");

    // 🔥 CƠ CHẾ BẢO VỆ: Nếu không tìm thấy báo cáo cũ hoặc báo cáo đã xử lý (Không còn PENDING)
    if (existingReport == null || !"PENDING".equalsIgnoreCase(existingReport.getStatus())) {
        response.sendRedirect(request.getContextPath() + "/MainController?action=explore");
        return;
    }

    // 4. Lấy danh sách cấu hình lý do để render thẻ select
...
<html lang="vi" class="dark">
    <head>
        ...
        <title>Chỉnh sửa báo cáo - AI Study Hub</title>
    ...
    <body class="page-body">
        ...
        <main class="main-content">
            <div class="header-container max-w-3xl">
                <h1 class="page-title dark:text-white">Cập nhật báo cáo vi phạm</h1>
