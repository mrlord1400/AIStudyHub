    ...
    <body class="page-body">
        ...
        <aside class="sidebar">
            <div class="space-y-6 w-full">
                ...
                <nav class="space-y-1 w-full">
                    ...
                    <a href="<%= request.getContextPath()%>/MainController?action=reportConfigList" class="nav-link">
        ...
        <main class="flex-1 p-8 overflow-y-auto h-screen relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-emerald-600 p-6 rounded-2xl shadow-sm flex items-center justify-between border-none">
                    <div>
                        <p class="text-white/80 text-xs font-medium uppercase tracking-wider mb-1">Tổng nạp thành công</p>
                        <h3 class="text-xl font-bold text-white">+<%= String.format("%,.0f", totalDeposit)%> VNĐ</h3>
                    </div>
