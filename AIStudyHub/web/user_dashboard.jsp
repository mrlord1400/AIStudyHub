...
<html lang="vi">
    ...
    <body class="page-body">
            ...
            <div class="w-full space-y-4">
                ...
                <div class="user-area">
                    <div class="flex items-center justify-between w-full">
                        <a href="<%= request.getContextPath()%>/MainController?action=profile" class="user-profile-link flex-1 mr-2 min-w-0">
        ...
        <main class="main-content">
            ...
            <div class="mb-8 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 shadow-sm transition-colors">
                <div class="flex items-center justify-between mb-3">
                    <span class="text-sm font-medium text-gray-600 dark:text-gray-300">Dung lượng đã sử dụng (<%= role%>)</span>
                    <span class="text-sm font-bold text-gray-900 dark:text-white"><%= String.format(java.util.Locale.US, "%.2f", totalSizeGb)%> GB / <%= (int) maxStorageGb%> GB</span>
                </div>
                <div class="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-2.5">
                    <div class="bg-[#5c3cf5] h-2.5 rounded-full transition-all duration-500 ease-out" style="width: <%= String.format(java.util.Locale.US, "%.1f", storagePercent)%>%"></div>
                </div>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-3 font-medium">
                    <%= isPremiumUser ? "Bạn đang sử dụng gói Premium cao cấp với đặc quyền tải tập tin lên đến 100MB." : "Nâng cấp lên Premium để có thêm 50GB dung lượng & mở rộng giới hạn file lên đến 100MB."%>
                </p>
            </div>
